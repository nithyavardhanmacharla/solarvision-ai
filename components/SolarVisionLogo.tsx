...
export function SolarVisionLogo({
  ...
  return (
    <div
      onClick={onClick}
      className={`flex items-center gap-3 ${onClick ? 'cursor-pointer hover:opacity-90 transition-all group select-none' : ''} ${className}`}
    >
      {Emblem}
      <div className="flex flex-col">
        <div className="flex items-center gap-2">
          <span className="font-extrabold text-lg sm:text-xl tracking-tight uppercase flex items-center gap-1 font-sans">
        ...
        <p className="text-[10px] text-zinc-400 font-mono tracking-wider uppercase hidden sm:block">
          PHYSICS SIMULATION & SOLAR RESOURCE INTELLIGENCE
        </p>
      </div>
    </div>
