...
export function ProjectManagerModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in">
      <div data-gsap="fade-up" className="w-full max-w-2xl glass-card rounded-2xl border border-slate-800 shadow-2xl p-4 sm:p-6 text-slate-100 flex flex-col max-h-[85vh]">
        {/* Header */}
