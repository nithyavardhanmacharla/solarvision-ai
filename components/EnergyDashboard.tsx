      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div data-gsap="fade-up" className="glass-card rounded-2xl p-5 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3 my-2">
            <div className="bg-emerald-500/10 border border-emerald-500/20 p-3 sm:p-3.5 rounded-xl text-center">
              <span className="text-[11px] font-semibold text-emerald-400 block mb-1">Self Consumption</span>
              <span className="font-mono text-lg sm:text-xl font-bold text-emerald-300">
            ...
            <div className="bg-sky-500/10 border border-sky-500/20 p-3 sm:p-3.5 rounded-xl text-center">
              <span className="text-[11px] font-semibold text-sky-400 block mb-1">Battery Charging</span>
              <span className="font-mono text-lg sm:text-xl font-bold text-sky-300">
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 p-3 sm:p-3.5 rounded-xl text-center">
