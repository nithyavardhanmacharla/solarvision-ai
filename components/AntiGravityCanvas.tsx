...
export function AntiGravityCanvas({ className = '', scrollContainerRef }: AntiGravityCanvasProps) {
  ...
  return (
    <div
      className={`relative w-full h-[520px] sm:h-[620px] rounded-3xl overflow-hidden bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 border border-zinc-800/80 shadow-2xl touch-none select-none overscroll-contain ${className}`}
