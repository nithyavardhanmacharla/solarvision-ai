...
export function ReportGeneratorView({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ------------------------------------------------------------- */}
      <div className="bg-zinc-950 border border-zinc-800 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-zinc-100 space-y-6 sm:space-y-8 shadow-2xl print:bg-white print:text-black print:p-0 print:border-none print:shadow-none font-sans">
        {/* =========================================================== */}
        {/* PAGE 1: TITLE, EXECUTIVE SUMMARY & TECHNICAL SPECS          */}
        {/* =========================================================== */}
        <div className="space-y-6 print:min-h-screen print:page-break-after">
          {/* Header */}
          <div className="flex flex-col sm:flex-row justify-between items-start gap-4 pb-6 border-b border-zinc-800 print:border-gray-300">
            <div>
            ...
            <div className="text-left sm:text-right text-xs text-zinc-400 print:text-gray-700 font-mono space-y-0.5">
