        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1">
          ...
          <div className="space-y-3 pb-4 border-b border-zinc-800">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-mono font-semibold px-2 py-0.5 rounded bg-zinc-800 text-amber-400 border border-zinc-700">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] font-mono font-semibold px-2 py-0.5 rounded bg-zinc-800 text-yellow-400 border border-zinc-700">
